"""
Django settings for oryx_smart_speedometer project.
...
ROOT_URLCONF = 'oryx_smart_speedometer.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'speedo.views.user_devices_processor',  # Добавляем наш процессор для устройств
            ],
        },
    },
]

WSGI_APPLICATION = 'oryx_smart_speedometer.wsgi.application'


# Database
# https://docs.djangoproject.com/en/5.1/ref/settings/#databases

# Настройка базы данных с поддержкой Railway
...
# Настройка статических файлов для Railway с WhiteNoise
...
# Настройка безопасности для Railway
